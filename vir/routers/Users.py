...
router = APIRouter()
@router.post("/users/", response_model=User,status_code=status.HTTP_202_ACCEPTED)
...
@router.put("/users/{user_id}", response_model=User,status_code=status.HTTP_202_ACCEPTED )
...
@router.delete("/users/{user_id}", response_model=User, status_code=status.HTTP_202_ACCEPTED)
